...
fn test_mphe() {
    ...
    let rlk0_r2 = key_share0.leaf_mphe_r2(mphe0,key_r1);
    let rlk1_r2 = key_share1.leaf_mphe_r2(mphe1,key_r1_);
    let rlk2_r2 = key_share2.leaf_mphe_r2(mphe2,key_r1__);
    let root_mphe = unsafe{&mut *(&mut rsmphe as *mut RootServerMPHE)};

    server_a.root_mphe_receive_r2(root_mphe,rlk0_r2,rlk1_r2,rlk2_r2);
    let x = 6;
