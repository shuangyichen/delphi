...
use experiments::minionn::construct_minionn_remote;
...
fn main(){
    ...
    // let mut network_c = construct_minionn_remote(None, split_layer,&mut rng);
    let mut network_c = construct_minionn_second_split(None, 1, layers, &mut rng,2);
