...
use experiments::resnet32::{construct_resnet_32,construct_resnet_32_split,construct_resnet_32_second_split,construct_resnet_32_split_a,construct_resnet_32_remote};
...
fn main(){
    ...
    let mut network_b = construct_resnet_32_remote(None, split_layer,batch_size, &mut rng);
