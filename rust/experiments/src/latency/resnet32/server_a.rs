...
use experiments::resnet32::{construct_resnet_32,construct_resnet_32_split,construct_resnet_32_second_split,construct_resnet_32_split_a,construct_resnet_32_gateway,construct_resnet_32_remote};
...
fn main() {
    ...
    //split 2 
    let network2 = construct_resnet_32_remote(None, split_layer, &mut rng);
