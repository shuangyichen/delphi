...
use experiments::minionnmini::construct_minionnmini_remote;
...
fn main(){
    ...
    let mut network_c = construct_minionnmini_remote(None, split_layer,batch_size, &mut rng);
