...
use experiments::minionnmini::construct_minionnmini_user;
use std::io::Read;
use std::path::Path;
use rand::ChaChaRng;
...
fn main() {
    ...
    let network = construct_minionnmini_user(None,split_layer,&mut rng);
