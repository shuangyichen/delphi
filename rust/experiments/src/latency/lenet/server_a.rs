...
use experiments::lenet::{construct_lenet,construct_lenet_gateway,construct_lenet_remote};
...
fn main() {
    ...
    let mut network1 = construct_lenet_gateway(None, split_layer,batch_size, &mut rng);
    ...
    //split 2 
    let network2 = construct_lenet_remote(None, split_layer, batch_size, &mut rng);
