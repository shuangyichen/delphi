...
use experiments::lenet::{construct_lenet,construct_lenet_remote};
...
fn main(){
    ...
    let mut network_b = construct_lenet_remote(None, split_layer,batch_size, &mut rng);
